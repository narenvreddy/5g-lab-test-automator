...
async function apiFetch(method, endpoint, payload) {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-3 px-4 pt-3 pb-3 pr-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 w-[120px] flex-shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] text-muted-foreground uppercase tracking-widest leading-none", children: "Request Type" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] text-muted-foreground uppercase tracking-widest leading-none", children: "Details" }),
            isFetchingDetails ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 w-[130px] flex-shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] text-muted-foreground uppercase tracking-widest leading-none", children: "Device ID" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5 flex-shrink-0 items-end", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Badge,
              {
                ...
                children: [
                  row.status === "running" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-1 inline-block w-1.5 h-1.5 rounded-full bg-primary animate-pulse" }),
                  statusCfg.label
                ]
              }
            ),
...
function App() {
  ...
  const [rowUI, setRowUI] = reactExports.useState({});
  const [isLoading, setIsLoading] = reactExports.useState(true);
  const [serverError, setServerError] = reactExports.useState(null);
  const debounceTimers = reactExports.useRef(
    {}
  );
  reactExports.useEffect(() => {
    (async () => {
  ...
  const handleTestIdChange = reactExports.useCallback((id, value) => {
    setRows(
      (prev) => prev.map((r2) => r2.id === id ? { ...r2, testId: value } : r2)
    );
  ...
  const handleDeviceIdChange = reactExports.useCallback((id, value) => {
    setRows(
      (prev) => prev.map((r2) => r2.id === id ? { ...r2, deviceId: value } : r2)
    );
  }, []);
  const handleRequestTypeChange = reactExports.useCallback((id, value) => {
    setRows(
      (prev) => prev.map((r2) => r2.id === id ? { ...r2, requestType: value } : r2)
    );
  ...
  const handleStart = async (id) => {
    ...
    setRows(
      (prev) => prev.map((r2) => r2.id === id ? { ...r2, status: "running" } : r2)
    );
    try {
      ...
      setRows(
        (prev) => prev.map(
          (r2) => r2.id === id ? { ...r2, status: "error", results: `Error: ${msg}` } : r2
        )
      );
    }
  };
  ...
  const handleAddRow = async () => {
    ...
    try {
      ...
      setRows((prev) => prev.map((r2) => r2.id === localId ? { ...saved } : r2));
    } catch (err) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dark min-h-screen bg-background text-foreground flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 bg-card border-b border-border shadow-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 h-16 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-4 mr-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-mono font-semibold", children: runningCount }),
              " ",
              "running"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-chart-1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-chart-1 font-mono font-semibold", children: completedCount }),
              " ",
              "completed"
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Signal, { className: "w-3.5 h-3.5 text-primary" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-primary", children: "NR-SA LIVE" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card/60 border-b border-border/60 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 h-10 flex items-center gap-6", children: ["Dashboard", "Test Suites", "Reports", "Lab Status"].map(
      (nav, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `text-xs font-medium tracking-wide transition-smooth ${i === 0 ? "text-primary border-b-2 border-primary pb-0.5" : "text-muted-foreground hover:text-foreground"}`,
          children: nav
        },
        nav
      )
    ) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-8", children: [
      serverError && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "flex-1 text-sm leading-snug", children: serverError }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-display font-semibold text-foreground tracking-tight", children: "Test Rows" }),
      ...
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Loading test rows…" })
          ]
        }
      ),
          ...
          children: rows.map((row, index2) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              TestRowCard,
              {
                row,
                rowIndex: index2,
                isFetchingDetails: ((_a2 = rowUI[row.id]) == null ? void 0 : _a2.isFetchingDetails) ?? false,
      ...
      !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card/40 border-t border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 h-10 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-chart-1 animate-pulse" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-mono text-muted-foreground", children: "System Online" })
      ] })
    ] }) })
  ] });
}
