...
export class Backend implements backendInterface {
    ...
    async fetchTestData(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchTestData(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getTestData(arg0: string): Promise<[string, string] | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getTestData(arg0);
    ...
    async setTestData(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setTestData(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async startFetching(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.startFetching(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [[string, string]]): [string, string] | null {
